...
from deoxys.deoxys import config_root
from deoxys.deoxys.franka_interface import FrankaInterface
from deoxys.deoxys.utils import YamlConfig
from deoxys.deoxys.utils.config_utils import (add_robot_config_arguments,
                                       get_default_controller_config)
from deoxys.deoxys.utils.input_utils import input2action
from deoxys.deoxys.utils.io_devices import SpaceMouse
from deoxys.deoxys.utils.log_utils import get_deoxys_example_logger

from camera_redis_interface import CameraRedisSubInterface
...
def main():
    ...
    cr_interface = CameraRedisSubInterface(camera_id=args.cam_id)
    cr_interface.start()
    ...
    while i < 2000:
        ...
        #Reading in the images from camera - based on Shuo's code
