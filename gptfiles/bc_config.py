...
class BCConfig(BaseConfig):
    ...
    def algo_config(self):
        ...
        #GPT policy settings
        self.algo.gpt.enabled = False
        self.algo.gpt.vocab_size = 400
        self.algo.gpt.block_size = 128
        self.algo.gpt.n_embd =  768
        self.algo.gpt.n_layer =  12
        self.algo.gpt.n_head = 12
        self.algo.gpt.open_loop = False